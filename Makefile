...
TEXTINC = -I ~/.brew/Cellar/freetype/2.9.1/include/freetype2/
...
$(NAME):
	...
	@$(COMP) -o $(NAME) $(SRC) $(CPPFLAGS) $(CPPSTD) $(INC) $(LIB) $(TEXTINC) $(GLMINC) $(SOUNDLIB) $(SOUNDFLAGS) -lglfw3 -lGLEW -lfreetype
	clear
